#ifndef  __CN93XX_VF_CONFIG_DATA_H__
#define  __CN93XX_VF_CONFIG_DATA_H__

/** Default configuration
 *  for CN93XX OCTEON Model.
 */

cn93xx_vf_config_t default_cn93xx_vf_conf = {
	/** IQ attributes */
	.iq = {
	       .max_iqs = CN93XX_VF_CFG_IO_QUEUES,
	       .max_base_iqs = OCTEON_MAX_93XX_VF_BASE_IOQ,
	       .pending_list_size =
	       (CN93XX_MAX_IQ_DESCRIPTORS * CN93XX_VF_CFG_IO_QUEUES),
	...
	/** OQ attributes */
	.oq = {
	       .max_oqs = CN93XX_VF_CFG_IO_QUEUES,
	       .max_base_oqs = OCTEON_MAX_93XX_VF_BASE_IOQ,
