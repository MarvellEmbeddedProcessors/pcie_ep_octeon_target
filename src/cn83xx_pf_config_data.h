#ifndef  __CN83XX_PF_CONFIG_DATA_H__
#define  __CN83XX_PF_CONFIG_DATA_H__

/** Default configuration
 *  for CN83XX OCTEON Model.
 */

cn83xx_pf_config_t default_cn83xx_pf_conf = {
	/** IQ attributes */
	.iq = {
	       .max_iqs = CN83XX_CFG_IO_QUEUES,
	       .max_base_iqs = OCTEON_MAX_83XX_BASE_IOQ,
	       .pending_list_size =
	       (CN83XX_MAX_IQ_DESCRIPTORS * CN83XX_CFG_IO_QUEUES),
	...
	/** OQ attributes */
	.oq = {
	       .max_oqs = CN83XX_CFG_IO_QUEUES,
	       .max_base_oqs = OCTEON_MAX_83XX_BASE_IOQ,
	...
	.pf_sriov_cfg[0] = {
			    .start_ring_num = CN83XX_EPF_START_RING_NUM,
			    .total_pf_rings = CN83XX_EPF_MAX_RINGS,
			    .rings_per_vf = CN83XX_EPF_RINGS_PER_VF,
			    .num_vfs = CN83XX_EPF_NUM_VFS}
	,
