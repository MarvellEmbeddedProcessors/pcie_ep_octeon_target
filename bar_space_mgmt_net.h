...
#define OTXMN_HOST_MBOX_ACK_REG         (OTXMN_HOST_RW_OFFSET + 8)
#define OTXMN_HOST_MBOX_OFFSET		(OTXMN_HOST_RW_OFFSET + 16)
...
#define OTXMN_TARGET_MBOX_ACK_REG		(OTXMN_TARGET_RW_OFFSET + 8)
#define OTXMN_TARGET_MBOX_OFFSET		(OTXMN_TARGET_RW_OFFSET + 16)
