...
#define OCTEP_SDP_RVU_PF_PER_PEM_MAX		2
...
#define OCTEP_CP_SOC_MODEL_CN96xx_D0		BIT_ULL(3)
...
#define OCTEP_CP_SOC_MODEL_CN98xx_B0		BIT_ULL(18)
...
#define OCTEP_CP_SOC_MODEL_CN98xx_Bx		(OCTEP_CP_SOC_MODEL_CN98xx_B0)
