 ...
 *
 * The context can be used to obtain the interface specific fn_cfg
 * data structure
 *
 ...
 */
int octep_plugin_relay_server_init(void)
{
 ...
 * return: (int) 0 on success, -errno on failure
 */
int octep_plugin_ctrl_net_lock(void)
{
 ...
 * return: (int) 0 on success, -errno on failure
 */
int octep_plugin_relay_process_msg(struct octep_cp_msg *msg)
{
	struct octep_plugin_msg plugin_msg = { 0 };
	struct fn_cfg *fn;
	int sockfd;

	fn = app_config_get_fn(&cfg, &msg->info);
 ...
 * return: (int) 0 on success, -errno on failure
 */
int octep_plugin_ctrl_net_unlock(void)
{
 ...
 * return: void
 */
void octep_plugin_relay_server_uninit(void)
{
