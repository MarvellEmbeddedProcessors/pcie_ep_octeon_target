...
/*! \file  cn93xx_vf_device.h
    \brief Host Driver: Routines that perform CN93XX specific VF domain operations.
*/

#ifndef  __CN93XX_VF_DEVICE_H__
#define  __CN93XX_VF_DEVICE_H__

#include "cn93xx_vf_regs.h"
